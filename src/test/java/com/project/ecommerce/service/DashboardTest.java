...
public class DashboardTest {
    ...
    void testGetBalance() {
        ...
        balance = dashboardService.getBalance(LocalDate.of(2023, 9, 13), null);
    ...
    void testMonthlyBalance() {
        ...
        balance = dashboardService.getMonthlyBalance(2024);
    ...
    void testYearlyBalance() {
        ...
        balance = dashboardService.getYearlyBalance(2024, 2025);
